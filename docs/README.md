...
| 文档 | 路径 | 说明 |
|------|------|------|
| 需求说明书 | [需求说明书.md](./需求说明书.md) | 业务目标、角色、FR/NFR、验收 |
| 概要设计 | [概要设计.md](./概要设计.md) | 架构、模块、流程、部署 |
| 详细设计 | [详细设计.md](./详细设计.md) | API、状态机、AI 管线、配置、错误码 |
| 数据字典 | [数据字典.md](./数据字典.md) | 表/字段/枚举/JSON/文件结构 |
